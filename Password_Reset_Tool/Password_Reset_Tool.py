...
serverip = {"M15":"python_connect","M16":"python_connect"} #predefined DSN is assigned with name, this needs to be set up and the odbc needs to be shared with all TD user.
